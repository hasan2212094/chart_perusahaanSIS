      ...
      <div class="container">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{asset('/assets.pluginAdmin/images/logo.svg')}}" alt="logo" />
            <span class="font-12 d-block font-weight-light">Responsive Dashboard </span>
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('assets.pluginAdmin/images/logo-mini.svg')}}" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="{{asset('/assets.pluginAdmin/images/faces/face1.jpg')}}" alt="image" />
                </div>
