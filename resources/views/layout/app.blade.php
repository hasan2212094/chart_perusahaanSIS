...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/vendors/mdi/css/materialdesignicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/vendors/flag-icon-css/css/flag-icon.min.css')}}">
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/vendors/css/vendor.bundle.base.css')}}">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/vendors/jquery-bar-rating/css-stars.css')}}">
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/vendors/font-awesome/css/font-awesome.min.css')}}">
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/css/demo_2/style.css')}}">
    <!-- End layout styles -->
    <link rel="stylesheet" href="{{asset('/assets.pluginAdmin/images/favicon.png')}}">
  </head>
  <body>
          ...
          <div class="content-wrapper pb-0">
            ...
            <div class="row">
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="{{asset('assets.pluginAdmin/images/dashboard/img_1.jpg')}}" alt="" />
                  </div>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid w-100" src="{{asset('assets.pluginAdmin/images/dashboard/img_2.jpg')}}" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body p-0">
                    <img class="img-fluid" src="{{asset('assets.pluginAdmin/images/dashboard/img_3.jpg')}}" alt="" />
                  </div>
                  <div class="card-body px-3 text-dark">
                    <div class="d-flex justify-content-between">
                      <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face2.jpg')}}" class="mr-2" alt="image" /> Jacob Jensen </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face3.jpg')}}" class="mr-2" alt="image" /> Cecelia Bradley </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face4.jpg')}}" class="mr-2" alt="image" /> Leah Sherman </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face5.jpg')}}" class="mr-2" alt="image" /> Ina Curry </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face7.jpg')}}" class="mr-2" alt="image" /> Lida Fitzgerald </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face2.jpg')}}" class="mr-2" alt="image" /> Stella Johnson </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('assets.pluginAdmin/images/faces/face9.jpg')}}" class="mr-2" alt="image" /> Maria Ortiz </td>
                            <td>
                              <div class="d-flex">
                                <span class="pr-2 d-flex align-items-center">65%</span>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                  <div class="card-body">
                    <img class="img-fluid card-top-img w-100" src="{{asset('assets.pluginAdmin/images/dashboard/img_5.jpg')}}" alt="" />
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{asset('assets.pluginAdmin/vendors/js/vendor.bundle.base.js')}}"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="{{asset('assets.pluginAdmin/vendors/jquery-bar-rating/jquery.barrating.min.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/chart.js/Chart.min.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/flot/jquery.flot.categories.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/flot/jquery.flot.fillbetween.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/vendors/flot/jquery.flot.stack.js')}}"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="{{asset('assets.pluginAdmin/js/off-canvas.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/js/hoverable-collapse.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/js/misc.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/js/settings.js')}}"></script>
    <script src="{{asset('assets.pluginAdmin/js/todolist.js')}}"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="{{asset('assets.pluginAdmin/js/dashboard.js')}}"></script>
